...
//global $wp_query;
//$args = array_merge( $wp_query->query_vars, array( 'post__not_in' => 'ignore_sticky_posts' => 1, $feat_post )  );
//$args = array_merge( $wp_query->query_vars, array( 'post__not_in' => array(get_option( 'sticky_posts' ), $feat_post ) ) );
//$args = array_merge( $wp_query->query_vars, array( 'post__not_in' => array(get_option( 'sticky_posts' )) ) );
$args = array_merge( $wp_query->query_vars, array( 'offset' => $story_count, 'ignore_sticky_posts' => 1, 'post__not_in' => array(get_option( 'sticky_posts' )), $feat_post)  );
unset($args['post__in']);
echo 'args = ' . PHP_EOL . var_dump($args) . PHP_EOL;
query_posts( $args );
