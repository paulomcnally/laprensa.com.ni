<?php date_default_timezone_set('America/Managua'); echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="15" align="left" margin="0" class="fp-title-bar"]<a href="http://noticias.laprensa.com.ni/category/ultimo-hora/">Últimas noticias</a> - '.date('M-d h:i a').'[/doap_heading][/doap_animate]</div> '); ?>
<?php //echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="15" align="left" margin="0" class="fp-title-bar"]<a href="http://noticias.laprensa.com.ni/category/ultimo-hora/">Ultimo Hora</a> - '.the_date('Y-m-d', '<span style=font-size:.8em>', '</span>').'[/doap_heading][/doap_animate]</div> '); ?>

		<?php //echo "<div style=position:relative;float:right;color:#000;background-color:#fff;>".count($posts)." posts</div>"; ?>
...
<?php $thelink = get_the_permalink();
      ...
      $thetime2 = "<div style=color:#369;padding-left:3px;padding-right:3px;background-color:#fff;position:relative;float:right;font-family:Arial;max-width:50px;font-size:.8em;>(".get_the_time('g:i a').")</div>";
...
<a href="<?php the_permalink(); ?>">
        <?php echo do_shortcode('[doap_tooltip style="tipsy" position="north" shadow="yes" rounded="yes" size="3" content="'. $theexcerpt .'" class="todays-news"]'. $thetime2 . $thetitle .'[/doap_tooltip]'); ?>
</a></div></div>
