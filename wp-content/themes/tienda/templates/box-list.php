<?php date_default_timezone_set('America/Managua'); //echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="15" align="left" margin="0" class="fp-title-bar"]<a href="http://noticias.laprensa.com.ni/tienda">Noticias Más leídas</a>[/doap_heading][/doap_animate]</div> '); ?>

<div style="width:100%;max-height:260px;" class="su-posts su-posts-list-loop">
<?php
// Posts are found
if ( $posts->have_posts() ) {
...
<div style="position:relative;float:left;width:50%;"  id="su-post-<?php the_ID(); ?>" class="su-post">
...
?>
<div style="max-width:200px;min-height:60px;">
