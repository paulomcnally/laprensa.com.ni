...
<?php
$args = array( 'posts_per_page' => 2, 'offset'=> 3, 'orderby'=> 'post_date', 'order'=> 'DESC', 'meta_key'=> '_thumbnail_id', 'post_status' => 'publish', 'category' => '2293,1672,27' );
...
foreach ( $myposts as $post )
{
        ...
        echo '</div>';
        //echo '<div class="destacados-titles"><h5 class="entry-title"><a href="' . $post_url . '">'. $title . '</a></h5></div>' . PHP_EOL;
        echo '<div class="destacados-titles" style="padding:4px;"><h5 class="tcpf"><a href="' . $post_url . '">'. $title . '</a></h5></div>' . PHP_EOL;
