<div class="su-posts su-posts-default-loop">
	<?php
		...
		<div style="border-top:4px solid #DD579A;border-bottom:3px solid #DD579A;"><h2 class="su-post-title"><a style="color:#dd579a;font-family:StagSansBook;position:relative;top:3px;left:-100px;" href="<?php the_permalink(); ?>">Editorial</a></h2></div>
