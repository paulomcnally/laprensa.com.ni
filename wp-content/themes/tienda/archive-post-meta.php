...
<?php if( is_single() ): ?>
	...
	<?php echo do_shortcode('<div style="position:relative;top:-10px;">[doap_animate type="lightSpeedIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]'.ucfirst(get_the_title()).'[/doap_heading][/doap_animate]</div>'); ?>
