...
<h5 style="background-color:#4c4c4c;color:#fff;position:relative;top:28px;width:130px;padding-left:5px;padding-bottom:4px;padding-top:5px;padding-right:5px;height:25px;float:right;">Departamentales</h5>

                        <div class="tcp-grid-item" style="min-height:370px;">
...
echo "</div>"; ?>
                                                <!-- .tcp-product-thumbnail -->
                                 <?php else : ?>

						<div class="tcp-product-thumbnail tcp-no-image">
							<a class="tcp_size-<?php echo $image_size;?>" href="<?php tcp_the_permalink(); ?>">
<img class="thumbnail" src="http://laprensa13.doap.us/wp-content/uploads/sites/2/2014/04/laprensanota-departamentales.jpg" style="max-width:100%" alt="" title="<?php the_title(); ?>">
</a>
