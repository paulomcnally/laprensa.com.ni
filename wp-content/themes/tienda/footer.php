...
<div id="footer" class="clearfix">
	...
	<div id="footer-wrapper">
		...
		<div class="grid col-300 fit powered">
			<a href="<?php echo esc_url( 'http://doap.com/' ); ?>" title="<?php esc_attr_e( 'Responsive Theme hosted by Doap.com', 'responsive' ); ?>">
				La Prensa</a>
			<?php esc_attr_e( 'powered by', 'responsive' ); ?> <a href="<?php echo esc_url( 'http://doap.com/' ); ?>" title="<?php esc_attr_e( ' doap.com', 'responsive' ); ?>">
