...
<img class="thumbnail" src="http://laprensa13.doap.us/wp-content/uploads/sites/2/2014/04/laprensanota-tecnologia.jpg" style="max-width:100%" alt="" title="<?php the_title(); ?>">
					...
					<?php endif; ?>
                                ...
                                <?php if ( $see_title ) : ?>
                                        <div class="sports-titles" style="position:relative;top:-12px;padding:0px;font-color:#000000;color:#000000;">
<?php echo $title_tag;?><a href="<?php tcp_the_permalink( );?>"><font color="#000000"><?php the_title(); ?></font></a>
