...
<?php echo do_shortcode('[doap_spacer size="75"][xyz-ips snippet="promociones-video-widget"]'); ?>

<?php echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://noticias.laprensa.com.ni/tienda">La tienda de La Prensa</a>[/doap_heading][/doap_animate]</div> '); ?>
