...
<?php //get_sidebar('ads-top'); ?>
<div style="width:1000px;height:90px;border:1px solid #000;">
<?php include('/var/www/html/lpmu/wp-content/themes/noticias' . '/banner-ad-widget-728x90.php'); ?>
<?php include('/var/www/html/lpmu/wp-content/themes/noticias' . '/banner-ad-widget-260x90.php'); ?>
</div>
<div style="clear:both;"></div>
...
<div style="height:90px;width:728px;margin-left:138px;"><?php include('/var/www/html/lpmu/wp-content/themes/noticias' . '/banner-midpage-index.php'); ?></div>
<div style="clear:both"></div>
...
echo '<div style="width:100%;padding-left:5px;padding-right:5px;max-width:80%;">Haga clic este boton y seleccione la edicion quieres.  <a href="/2014/">Entre el archivo.</a></div></div>';
...
echo '<br><div id=magazine-ad><a href=http://magazine.laprensa.com.ni><iframe src=http://noticias.laprensa.com.ni/los-cuatro/magazine.html frameborder=0 scrolling=no height=137 width=728></iframe></a></div>';
