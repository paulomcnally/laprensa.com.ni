...
<?php $pullitcount = $pullitcount + 1; ?>
		<div class="tcp-product-<?php the_ID(); ?> tcp_col media">

				<?php if ( $see_image ) : ?>
						<?php if (has_post_thumbnail()) :  ?>
									<?php           $pullitcount =  rand(1,100);
									if ($pullitcount % 2 == 0) {
									$pullit = "pull-left"; 
									} else { 
									$pullit = "pull-right"; 
									} ?>
									<div class="entry-post-thumbnail <?php echo $pullit; ?>">
						...
						<?php else : ?>
								...
								<div class="<?php echo $pullit ?>" style="width:140px;">
									<a class="media-objet tcp_size-<?php echo $image_size;?>" href="<?php the_permalink(); ?>"><img src="<?php echo "http://noticias.laprensa.com.ni/wp-content/uploads/sites/2/2014/04/laprensanota-tecnologia.jpg"; ?>" alt="No image" title="" width="" height="" /></a>
								</div><!-- .entry-post-thumbnail -->
						<?php endif; ?>	
				<?php endif; ?>
