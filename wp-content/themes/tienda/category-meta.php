...
<?php if( is_single() ): ?>
	<p class="antetitulo"><?php echo get_post_meta( get_the_ID(), 'antetitulo', true ); ?><p>
        <?php echo do_shortcode('<div style="position:relative;top:0px;">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]'.ucfirst(get_the_title()).'[/doap_heading][/doap_animate]</div>'); ?>
	<?php echo $intro; ?>
	<?php echo $autor; ?>
<?php else: ?>
        <?php echo do_shortcode('<div style="position:relative;top:0px;">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]'.ucfirst(get_the_title()).'[/doap_heading][/doap_animate]</div>'); ?>
