...
{
//echo 'HELLO';
echo '<div id="scoreboard-strip" style="border:0px;max-width:100%;">';
echo '<div style="position:relative;float:left;margin-right:10px;padding-bottom:2px;"><img src="http://laprensa13.doap.us/wp-content/themes/noticias/core/icons/' . $deporte_icon . '.png" alt="futbol" width="22" height="22" class="size-thumbnail wp-image-1146384" /></div>';
echo '<div style="position:relative;float:left;padding-top:2px;font-size:1.2em;font-weight:900;color:#fff;">'. $game_status . '</div></div>';
echo '<div style="clear:both;"></div>';
echo '<div class="shawn-marcador" style="width:100%;position:relative;float:left;border-top: 1px solid #ccc;border-bottom: 1px solid #ccc;">';
...
echo '<div style="line-height:1.6;'. $home_color . 'color:#fff;font-family:Arial;font-size:3.5em;font-weight:bold;width:100px;height:80px;text-align:center;vertical-align:middle;position:relative;float:left;border-right: 1px solid #ccc;">'. $home_score_meta . '</div>';
echo '<div style="line-height:1.6;' . $away_color . 'color:#fff;font-family:Arial;font-size:3.5em;font-weight:bold;width:100px;height:80px;text-align:center;vertical-align:middle;position:relative;float:left;border-left: 1px solid #ccc;">'. $away_score_meta . '</div>';
...
echo '<div class="futbol-total">';
echo $fb_slider;
echo '<div style="clear:both;"></div><div id="div-gpt-ad-1403883993058-0" style="background-color:#ccc;width:529px; height:70px;"></div>';
echo '</div>';
}
//wp_reset_query();
wp_reset_postdata();
