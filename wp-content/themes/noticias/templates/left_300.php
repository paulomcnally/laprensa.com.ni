<?php
$left_300_id = ($even == $left_300_story) ? 'left-300-story' : 'mini-post';
...
$theexcerpt = ($even == $left_300_story) ? get_doap_excerpt(88, 1, 1) : get_doap_excerpt(232,1,1);
...
$margin_right = ($even == $mini_post) ? 'padding-right:0px;' : 'padding-right:10px;margin-top:10px;';
...
$title = get_doap_limit_chars(the_title_attribute('echo=0'),40,1);
...
echo '<div class="img-div" style="' . $max_width . 'position:relative;margin-top:0px;margin-bottom:10px;border: 1px solid #ccc;">' . PHP_EOL;
echo '<a href="' . $post_url . '"><img src="' . $feat_image . '" style="' . $max_width . '">';
echo '<div class="excerpt-overlay" style="margin: 0px;position:absolute;display:block;bottom:0px;left:0px;' . $bottom_height . $max_width . $background . 'color:#fff;border-radius:0;opacity:1;font-family:Arial;text-align:left;">';
