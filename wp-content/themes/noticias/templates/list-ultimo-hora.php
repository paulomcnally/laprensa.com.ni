<?php date_default_timezone_set('America/Managua'); echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="15" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/category/ultimo-hora/">Últimas noticias</a> - '.date('M-d h:i a').'[/doap_heading][/doap_animate]</div> '); ?>
<?php //echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="15" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/category/ultimo-hora/">Ultimo Hora</a> - '.the_date('Y-m-d', '<span style=font-size:.8em>', '</span>').'[/doap_heading][/doap_animate]</div> '); ?>
