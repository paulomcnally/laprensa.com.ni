...
$args = array_merge( $wp_query->query_vars, array( 'category__in' => $themaincat, 'meta_query' => array( 'relation' => 'OR', array( 'key' => 'destacado', 'compare' => 'NOT EXISTS' ), array( 'key' => 'destacado', 'value' => 0, 'type' => 'NUMERIC' ) ), 'post__not_in' => $feat_post ) );
...
//var_dump($feat_post);
$even = 0; 
//echo do_shortcode('[doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/nacionales/page/2"><div class="title-left">MÁS EN ' . mb_strtoupper($single_cat_title) . '</div><div class="line-container"><div class="line"></div></div></a>[/doap_heading]');
if ($themaincat <> 1672)
{
echo '<div style="height:10px;clear:both;"></div>';
}
echo '<div class="su heading su-heading-style-modern-1-blue su-heading-align-left fp-title-bar" style="font-size:20px;margin:8px 5px 4px 4px"><a href="http://www.laprensa.com.ni/' . $single_cat_url . '"><div id="des-sec" class="title-left" style="margin-left:4px;">' . $sub_cat_title . '</div><div id="des-dot" class="twodots"></div></a></div>';
