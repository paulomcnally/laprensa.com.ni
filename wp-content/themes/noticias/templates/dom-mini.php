...
$sec_story_img = '<div style="position:relative;float:left;"><a href="' . $post_url . '"><img src="' . $feat_image . '" style="border: 1px solid #ccc;margin:4px 8px 2px 0px;"></a></div><div class="mobile-clear"></div>' . PHP_EOL;
...
echo '<div class="category-excerpt" style="padding:4px 10px 4px 4px;text-align:justify;">' . $theexcerpt . '</div>' . PHP_EOL;
echo '</div>';
