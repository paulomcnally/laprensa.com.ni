<?php date_default_timezone_set('America/Managua'); //echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="25" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tienda">Internacionales</a>[/doap_heading][/doap_animate]</div> '); ?>
...
<?php echo '<div style="position:relative;align:auto 0 0;width:270px;float:left;margin-left:5px;margin-right:10px;line-height:.8em;">';
//responsive_pro_featured_image();
//the_post_thumbnail( array(300,300) );
echo '<a title="' . $thetitle . '" href=" ' . $thelink . ' ">';
the_post_thumbnail( array(300,300) );
echo '</a>';
echo "</div>"; ?>
