<?php date_default_timezone_set('America/Managua'); //echo do_shortcode('<div id="tiendatitle">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="15" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tienda">Noticias Más leídas</a>[/doap_heading][/doap_animate]</div> '); ?>
