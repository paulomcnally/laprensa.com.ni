...
$args = array( 'posts_per_page' => 2, 'meta_key'=> '_thumbnail_id', 'post_status' => 'publish', 'cat' => 26, 'ignore_sticky_posts' => 1, 'date_query' => array(array('column' => 'post_date', 'after' => '1 month ago')) );
...
[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/departamentales"><div class="title-left">DEPARTAMENTALES</div><div class="line-container"><div class="line"></div></div></a>[/doap_heading][/doap_animate]'); 
