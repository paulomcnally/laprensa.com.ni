...
<?php echo do_shortcode('[doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/promociones/"><div class="title-left">PROMOCIONES</div><div class="twodots"></div></a>[/doap_heading]'); ?>
...
//echo do_shortcode('<div style="top:-20px;"class="centercol">[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/promociones">Promociones</a>[/doap_heading][/doap_animate] </div>'); ?>
...
<?php if ($gid > 10000000)  { include(STYLESHEETPATH . '/bottom-ads-loggedin.php'); } else { include(STYLESHEETPATH . '/banner-ad-widget-promocion-bottom-728x90.php'); echo ""; } ?>
