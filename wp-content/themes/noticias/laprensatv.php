...
<?php if (current_user_can( 'manage_options' ))  { } else { include(STYLESHEETPATH . '/lptv-page-wing-ads.php'); } ?>
<?php //include(STYLESHEETPATH . '/lptv-page-wing-ads.php'); ?>

<?php if (current_user_can( 'manage_options' ))  { echo '<div id="topad" title=""We are currently hiding ads for employees in an effort to speed internal workflow." style="position:relative;float:right;width:270px;height:90px;background-color:#fff;border:1px solid #000;padding:0px;margin:0px;font-family:Marvel;font-size:3em;font-weight:900;"><div style="top:30px;left:20px;position:relative;"><a href=doap.com>doap.com</a></div></div>'; } else { include(STYLESHEETPATH . '/banner-ad-widget-270x90.php'); } ?>

<?php if (current_user_can( 'manage_options' ))  { echo '<div id="topad" title="We are currently hiding ads for employees in an effort to speed internal workflow." style="position:relative;float:left;width:720px;height:90px;background-color:#fff;border:1px solid #000;padding:0px;margin:0px;font-family:Marvel;font-size:3em;font-weight:900;"><div style="top:30px;left:50px;position:relative;"><a href=doap.com>DevOps and Platforms</a></div></div>'; } else { include(STYLESHEETPATH . '/banner-ad-widget.php'); } ?>
