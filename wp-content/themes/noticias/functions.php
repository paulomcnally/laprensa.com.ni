...
//BOLETIN IMAGES SIZES 
add_image_size('boletin-featured', 575, 325, array( 'center', 'top' ) );
add_image_size('boletin-default', 270, 200, array( 'center', 'top' ) );
add_image_size('boletin-picked', 125, 80, array( 'center', 'top' ) );
add_image_size('boletin-lptv', 187, 105, array( 'center', 'top' ) );
