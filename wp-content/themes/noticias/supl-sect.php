<?php
echo do_shortcode('[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/suplemento"><div class="title-left">SUPLEMENTOS</div><div class="line-container"><div class="line"></div></div></a>[/doap_heading][/doap_animate]');
...
{	
	...
	echo '<div class="supl-img">' . PHP_EOL . '<a href="http://www.laprensa.com.ni/suplemento/nosotras"><img src="' . $feat_image . '"></a>' . PHP_EOL;
	echo '</div>' . PHP_EOL;
}
wp_reset_postdata();
...
{	
	...
	$feat_image_array = wp_get_attachment_image_src( get_post_thumbnail_id($my_post->ID), 'responsive-150' ); 
	$feat_image = $feat_image_array[0];
	echo '<div class="supl-img">' . PHP_EOL . '<a href="http://www.laprensa.com.ni/suplemento/aqui-entre-nos"><img src="' . $feat_image . '"></a>' . PHP_EOL;
	echo '</div>' . PHP_EOL;
}
wp_reset_postdata();
...
{	
	...
	$feat_image_array = wp_get_attachment_image_src( get_post_thumbnail_id($my_post->ID), 'responsive-150' ); 
	$feat_image = $feat_image_array[0];
	echo '<div class="supl-img">' . PHP_EOL . '<a href="http://www.laprensa.com.ni/suplemento/la-prensa-domingo"><img src="' . $feat_image . '"></a>' . PHP_EOL;
	echo '</div>' . PHP_EOL;
}
wp_reset_postdata();
...
{	
	...
	$feat_image_array = wp_get_attachment_image_src( get_post_thumbnail_id($my_post->ID), 'responsive-150' ); 
	$feat_image = $feat_image_array[0];
	echo '<div class="supl-img">' . PHP_EOL . '<a href="http://www.laprensa.com.ni/suplemento/empresariales"><img src="' . $feat_image . '"></a>' . PHP_EOL;
	echo '</div>' . PHP_EOL;
}
wp_reset_postdata();
