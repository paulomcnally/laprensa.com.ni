...
<h5 style="background-color:#4c4c4c;color:#fff;position:relative;top:28px;width:90px;padding-left:5px;padding-bottom:4px;padding-top:5px;padding-right:5px;height:25px;float:right;">Planeta</h5>
...
<img class="thumbnail" src="http://laprensa13.doap.us/wp-content/uploads/sites/2/2014/04/laprensanota-planeta.jpg" style="max-width:100%" alt="" title="<?php the_title(); ?>">
</a>
