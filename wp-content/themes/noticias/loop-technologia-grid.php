...
<div class="tcp-product-list tcpf">
	...
	while ( have_posts() ) : the_post();
        ...
        <?php                   echo "<div style=max-width:100%;min-width:140px;max-height:280px;float:right;overflow:hidden;padding:0px;margin-bottom:0px;>";
...
<img class="thumbnail" src="http://laprensa13.doap.us/wp-content/uploads/sites/2/2014/04/laprensanota-tecnologia.jpg" style="max-width:100%" alt="" title="<?php the_title(); ?>">
</a>
