<?php
echo do_shortcode('<div>[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/cartelera-de-cine"><div class="title-left">CARTELERA DE CINE</div><div class="line-container"><div class="line"></div></div></a>[/doap_heading][/doap_animate]');
echo '<div style="height:4px;clear:both;"></div><div class="cart-home-box">';
$args = array( 'post_type' => 'post', 'posts_per_page' => 3, 'meta_key'=> '_thumbnail_id', 'post_status' => 'publish', 'category__in' => 23782, 'ignore_sticky_posts' => 1 );
...
$img_url = wp_get_attachment_url(get_post_thumbnail_id($post->ID));
                        $image = su_image_resize( $img_url, 200, 298 );
                        if ($image['url'])
