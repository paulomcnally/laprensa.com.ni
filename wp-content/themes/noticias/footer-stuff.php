...
<div style="position:absolute;top:-90px;height:90px;width:728px;left:138px;"><?php include(STYLESHEETPATH . '/banner-midpage-index.php'); ?></div>
<div style="padding-left:0px;padding-top:5px;padding-bottom:5px;position:relative;left:0px;top:0px;" class="desacados_bar">
<div id="destacados">
<?php echo do_shortcode('[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/destacados">Destacados</a>[/doap_heading][/doap_animate]'); ?>
...
<?php //echo do_shortcode('[doap_spacer size="20"]'); ?>
<div style="position:absolute;top:0px;width:728px;height:90px;left:138px;"><?php //include(STYLESHEETPATH . '/banner-midpage-index.php'); ?></div>
</div>
<?php echo do_shortcode('[doap_spacer size="20"]'); ?>
