<?php
//echo do_shortcode('[xyz-ips snippet="tcp-product-grid-layout"]'); 
/**
 * General templates
 *
...
function tcp_posted_on() {
	printf( __( '<span class="tcp_posted_on"><span class="sep">Publicado el </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a></span>', 'tcp' ),
