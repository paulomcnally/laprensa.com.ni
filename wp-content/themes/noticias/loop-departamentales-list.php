				...
				<?php if ( $see_image ) : ?>
						...
						<?php else : ?>
								<div class="pull-left" style="width:140px;">
									<a class="media-objet tcp_size-<?php echo $image_size;?>" href="<?php the_permalink(); ?>"><img src="<?php echo "http://www.laprensa.com.ni/wp-content/uploads/sites/2/2014/04/laprensanota-departamentales.jpg"; ?>" alt="No image" title="" width="" height="" /></a>
								</div><!-- .entry-post-thumbnail -->
						<?php endif; ?>	
				<?php endif; ?>
