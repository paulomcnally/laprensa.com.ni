...
<?php include(STYLESHEETPATH . '/lptv-page-wing-ads.php'); ?>
...
<?php include(STYLESHEETPATH . '/banner-ad-widget.php'); ?>
...
<?php echo do_shortcode('[doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/lptv"><div class="title-left">VIDEOS DEL DIA</div><div class="twodots"></div></a>[/doap_heading]'); ?>
...
[doap_tabs class="my-lptv-tabs"]
  ...
  [doap_tab title="Mas Vistos "][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/lptv"><div class="title-left">MAS VISTOS</div><div class="twodots"></div></a>[/doap_heading][doap_posts template="templates/box-loop-videos.php" tax_term="19" tax_operator="0" author="1,102,108,113,114,116,117,103,111,118,112,110,107,115,120,106,104,105,119,109" order="desc" orderby="comment_count" post_parent=" " ignore_sticky_posts="no"] [/doap_tab]
  [doap_tab title="Moda"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tag/moda"><div class="title-left">MODA</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Belleza"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tag/belleza"><div class="title-left">BELLEZA</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Miercoles Frescos"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tag/miercoles-frescos"><div class="title-left">MIERCOLES FRESCOS</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Salud"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/salud"><div class="title-left">SALUD</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Familia"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/familia"><div class="title-left">FAMILIA</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Farandula"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tag/farandula"><div class="title-left">FARANDULA</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Noticiero LPTV"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/tag/noticiero-lptv"><div class="title-left">NOTICIERO LPTV</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
  [doap_tab title="Opinion"] [doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/opinion"><div class="title-left">OPINION</div><div class="twodots"></div></a>[/doap_heading] [/doap_tab]
[/doap_tabs]
...
<?php 
//echo do_shortcode('[doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/lptv"><div class="title-left">VIDEOS DEL DIA</div><div class="twodots"></div></a>[/doap_heading]'); 
?>

<?php
echo do_shortcode('[doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/lptv"><div class="title-left">VIDEOS DESTACADOS</div><div class="twodots"></div></a>[/doap_heading]');
?>
