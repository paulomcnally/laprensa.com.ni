...
<div class="tcp-product-list tcpf">
	...
	while ( have_posts() ) : the_post();
		...
		<div class="tcp-product-<?php the_ID(); ?> tcp_col tcp_col_<?php echo $tcp_col; ?> tcp_col_xs_<?php echo $tcp_col_xs; ?> <?php echo implode( ' ', $class ); ?>">
			...
			<div class="tcp-grid-item" style="border:0px solid #ffffff;box-shadow:none; padding-left:3px;padding-right:3px;padding-bottom:0px;padding-top:0px;">

				<?php if ( $see_image ) : ?>
                                        <?php if ( tcp_has_post_thumbnail() ) :  ?>
                                                  <?php //echo "<div style=max-width:100%;max-height:280px;float:right;padding-left:10px;padding-right:10px;>";
				echo "<div style=max-width:100%;min-width:140px;max-height:280px;float:right;padding:0px;margin-bottom:0px;>";
                                        //responsive_pro_featured_image();
                                        //the_post_thumbnail( array(240,160) );
                                        the_post_thumbnail( 'responsive-150' );
...
<img class="thumbnail" src="http://laprensa13.doap.us/wp-content/uploads/sites/2/2014/04/laprensanota-deportes.jpg" style="max-width:100%" alt="" title="<?php the_title(); ?>">
</a>
						</div><!-- .tcp-product-thumbnail -->
					<?php endif; ?>

                                <?php if ( $see_title ) : ?>
                                        <div class="sports-titles" style="position:relative;padding:0px;font-color:#000000;color:#000000;">
<?php echo $title_tag;?><a href="<?php tcp_the_permalink( );?>"><font style="position:relative;top:0px;float:left;" size="2" color="#333333"><?php the_title(); ?></font></a>
