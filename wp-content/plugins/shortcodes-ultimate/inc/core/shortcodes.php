	...
	public static function slider( $atts = null, $content = null ) {
		...
		if ( count( $slides ) ) {
			...
			foreach ( $slides as $slide ) {
				...
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="su-slider-slide-title">' .stripslashes( $slide['title'] ) : '';
//				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<span class="su-slider-slide-title">' . stripslashes( $slide['title'] ) . '</span>' : '';
				 $description = ( $atts['title'] === 'yes' && $slide['description'] ) ? '<div class="slide-description" style="top:215px;">' . stripslashes( $slide['description'] ).  '</div>' : '';
				if ($atts['title'] === 'yes' && $slide['title'] && $slide['description'])
				{
					$description .= '</div>';
				}
				else
				{
					if ($atts['title'] === 'yes' && $title) $title .= '</div>';
	...
	public static function futbol_slider( $atts = null, $content = null, $slides = array()) {
		$return = '';
		$atts = shortcode_atts( array(
				'source'     => 'none',
				'limit'      => 20,
...
//		var_dump($slides);
		...
		if ( count( $slides ) ) {
			...
			$size = ( $atts['responsive'] === 'yes' ) ? 'width:100%' : 'width:' . intval( $atts['width'] ) . 'px;height:' . intval( $atts['height'] ) . 'px';
			// Open slider
			$return .= '<div id="' . $id . '" class="su-slider' . $centered . ' su-slider-pages-' . $atts['pages'] . ' su-slider-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '"><div><a href="/deportes"><img src="http://laprensa13.doap.us/wp-content/uploads/sites/2/2014/06/bannerfutboltotalhome.jpg"></a></div><div class="su-slider-slides">';
			// Create slides
			foreach ( $slides as $slide ) {
				// Crop the image
				$image = su_image_resize( $slide['image'], $atts['width'], $atts['height'] );
				$home_logo = su_image_resize( $slide['home_logo'], 100, 103 );
				$away_logo = su_image_resize( $slide['away_logo'], 100, 103 );
				// Prepare slide title
				// Open slide
				$return .= '<div class="su-slider-slide">';
				// Slide content with link
				...
				// Close slide
				$return .= '<div class="game-summary">';
				$return .= '<div class="home-team"><div class="home-logo"><img src="' . $home_logo['url'] . '" alt=""></div><div class="team-name">' . $slide['home_team'] . '</div></div>';
				$return .= '<div class="away-team"><div class="away-logo"><img src="' . $away_logo['url'] . '" alt=""></div><div class="team-name">' . $slide['away_team'] . '</div></div>';
				$return .= '</div>';
				$return .= '<div class="score"><span class="value">' . $slide['score'] . '</span></div>';
				$return .= '</div>';
				if ( $slide['link'] ) $bottom_section .= '<div><a href="' . $slide['link'] . '"' . $target . '> >  ' . esc_attr( $slide['title'] ) . '</a></div>' . PHP_EOL;
			}
			// Close slides
			$return .= '</div>';
			// Open nav section
			...
			// Close nav section
			$return .= '</div>';
			$return .= '<div class="futbol-notas">' . $bottom_section . '</div>';
			// Close slider
			$return .= '</div>';
			// Add lightbox assets
			if ( $atts['link'] === 'lightbox' ) {
	...
	public static function nos_carousel( $atts = null, $content = null ) {
		$return = '';
		$atts = shortcode_atts( array(
				'source'     => 'none',
				'limit'      => 20,
...
//var_dump($query);
		if ( count( $slides ) ) {
			...
			if ( $atts['link'] === 'lightbox' ) $atts['class'] .= ' su-lightbox-gallery';
			// Open slider
			$return .= '<div id="category-slider2">';
			//$return .= '<div id="' . $id . '" class="su-carousel' . $centered . ' su-carousel-pages-' . $atts['pages'] . ' su-carousel-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '" data-items="' . $atts['items'] . '" data-scroll="' . $atts['scroll'] . '"><div style="height:50px;"></div><div class="lp-border"><div class="su-carousel-slides">';
			$return .= '<div id="' . $id . '" class="su-carousel' . $centered . ' su-carousel-pages-' . $atts['pages'] . ' su-carousel-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '" data-items="' . $atts['items'] . '" data-scroll="' . $atts['scroll'] . '"><div style="height:20px;background-color:#989898;margin-bottom:4px;"></div><div class="su-carousel-slides">';
			// Create slides
			foreach ( (array) $slides as $slide ) {
				// Crop the image
				$image_abc = su_image_resize( $slide['image'], 150, 220 );
				$image = $image_abc['url'];
				$div_width = round( $atts['width'] / $atts['items'] );
//				echo PHP_EOL . $slide['attach_id'];
				$div_width = 431;
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="nos_carousel_title"><a href="' . $slide['link'] . '"' . $target . '>' . stripslashes( $slide['title'] ) . '</a></div>' : '';
				// Open slide
				//$return .= '<div class="su-carousel-slide" style="max-width:200px;padding:5px;"><div>';
				//$return .= '<div class="su-carousel-slide"><div>';
				$return .= '<div class="su-carousel-slide" style="width:' . $div_width . 'px;">';
				// Slide content with link
				//if ( $slide['link'] ) $return .= '<a href="' . $slide['link'] . '"' . $target . '><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" /></a>';
				//if ( $slide['link'] ) $return .= '<div style="border:0px;max-width:200px;padding:5px;"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" /></a></div>';
				if ( $slide['link'] ) $return .= '<div class="img-div" style="width:150px;height:220px;position:relative;float:left;padding-right:18px;"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" /></a></div>';
				// Slide content without link
				//else $return .= '<a><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" />' . $title . '</a>';
				else $return .= '<a><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" />' . $title . '</a>';
				// Close div 
				//$return .= '</div>';
				//if ($slide['title']) $return .= '<div class="tcpf" style="max-width:200px;padding:5px;">' . $title . '</div>';
				//if ($slide['title']) $return .= '<div class="tcpf cat_carousel_title">' . $title . '</div>';
				$return .= '<div style="margin-left:10px;">';
				if ($slide['title'] && $atts['class'] <> 'carousel-cartelera') $return .= $title;
				//if ($slide['description']) $return .= '<div style="max-width:200px;margin-top:0px;padding:5px;">' . $slide['description'] . '</div>';
				if ($slide['description'] && $atts['class'] <> 'carousel-cartelera') $return .= '<div class="nos_carousel_description">' . $slide['description'] . '</div>';
				// Close slide
				$return .= '</div></div>';
			}
			// Close slides
	...
	public static function cat_carousel( $atts = null, $content = null ) {
		$return = '';
		$atts = shortcode_atts( array(
				'source'     => 'none',
				'limit'      => 20,
...
//var_dump($query);
		if ( count( $slides ) ) {
			...
			if ( $atts['link'] === 'lightbox' ) $atts['class'] .= ' su-lightbox-gallery';
			// Open slider
			$return .= '<div id="category-slider">';
			//$return .= '<div id="' . $id . '" class="su-carousel' . $centered . ' su-carousel-pages-' . $atts['pages'] . ' su-carousel-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '" data-items="' . $atts['items'] . '" data-scroll="' . $atts['scroll'] . '"><div style="height:50px;"></div><div class="lp-border"><div class="su-carousel-slides">';
			$return .= '<div id="' . $id . '" class="su-carousel' . $centered . ' su-carousel-pages-' . $atts['pages'] . ' su-carousel-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '" data-items="' . $atts['items'] . '" data-scroll="' . $atts['scroll'] . '"><div style="height:50px;"></div><div class="su-carousel-slides">';
			// Create slides
			foreach ( (array) $slides as $slide ) {
				// Crop the image
				if ($atts['class'] == 'carousel-cartelera')
				{
				$image_abc = su_image_resize( $slide['image'], round( $atts['width'] / $atts['items'] ), $atts['height'] );
				$image = $image_abc['url'];
				$div_width = round( $atts['width'] / $atts['items'] );
				}
//				echo PHP_EOL . $slide['attach_id'];
				...
				{
				$image_abc = wp_get_attachment_image_src( $slide['attach_id'], 'center-top-300x300', 0 );
				$image = $image_abc['0'];
				$div_width = 200;
				}
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<a href="' . $slide['link'] . '"' . $target . '><div class="tcpf cat_carousel_title"><h4>' . stripslashes( $slide['title'] ) . '</h4></div></a>' : '';
				// Open slide
				//$return .= '<div class="su-carousel-slide" style="max-width:200px;padding:5px;"><div>';
				//$return .= '<div class="su-carousel-slide"><div>';
				$return .= '<div class="su-carousel-slide" style="width:' . $div_width . 'px;">';
				...
				//if ( $slide['link'] ) $return .= '<a href="' . $slide['link'] . '"' . $target . '><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" /></a>';
				//if ( $slide['link'] ) $return .= '<div style="border:0px;max-width:200px;padding:5px;"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" /></a></div>';
				if ( $slide['link'] ) $return .= '<div class="img-div"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" /></a></div>';
				// Slide content without link
				//else $return .= '<a><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" />' . $title . '</a>';
				else $return .= '<a><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" />' . $title . '</a>';
				// Close div 
				...
				if ($slide['title'] && $atts['class'] <> 'carousel-cartelera') $return .= $title;
				//if ($slide['description']) $return .= '<div style="max-width:200px;margin-top:0px;padding:5px;">' . $slide['description'] . '</div>';
				if ($slide['description'] && $atts['class'] <> 'carousel-cartelera') $return .= '<div class="cat_carousel_description">' . $slide['description'] . '</div>';
				// Close slide
				$return .= '</div>';
			}
			// Close slides
	...
	public static function lptv_carousel( $atts = null, $content = null ) {
		$return = '';
		$atts = shortcode_atts( array(
				'source'     => 'none',
				'limit'      => 20,
...
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="lptv_carousel_title" style="background-color:#fff;line-height:1.1;font-size:.8em;font-weight:700;padding:2px 2px 2px 2px;text-align:center;"><a title="' . $slide['title'] . '" href="' . $slide['link'] . '">' . get_doap_limit_chars(stripslashes($slide['title']),41,1) . '</a></div>' : '';
				// Open slide
				//$return .= '<div class="su-carousel-slide" style="max-width:200px;padding:5px;"><div>';
				$return .= '<div class="su-carousel-slide">';
				//$return .= '<div class="su-carousel-slide" style="width:200px;">';
				// Slide content with link
				//if ( $slide['link'] ) $return .= '<a href="' . $slide['link'] . '"' . $target . '><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" /></a>';
				//if ( $slide['link'] ) $return .= '<div style="border:0px;max-width:200px;padding:5px;"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" /></a></div>';
				if ( $slide['video'] ) $vid_icon = '<div style="z-index:10;position:absolute;top:36px;left:10px;width:20px;height:20px;"><img src="http://laprensa13.doap.us/images/video_icon2.png" width="20" height="20" style="width:20px;height:20px;border:0;margin:0;pading:0;background-color:initial;"></div>';
				if ( $slide['link'] ) $return .= '<div class="img-div"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" /></a>' . $vid_icon . '</div>';
				// Slide content without link
				//else $return .= '<a><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" />' . $title . '</a>';
				else $return .= '<a><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" />' . $title . '</a>';
				// Close div 
				...
				//if ($slide['title']) $return .= '<div class="tcpf" style="max-width:200px;padding:5px;">' . $title . '</div>';
				//if ($slide['title']) $return .= '<div class="tcpf cat_carousel_title">' . $title . '</div>';
				if ($slide['title']) $return .= $title;
				//if ($slide['description']) $return .= '<div style="max-width:200px;margin-top:0px;padding:5px;">' . $slide['description'] . '</div>';
//				if ($slide['description']) $return .= '<div class="cat_carousel_description">' . $slide['description'] . '</div>';
				// Close slide
				$return .= '</div>';
			}
			// Close slides
	...
	public static function cat_breves_carousel( $atts = null, $content = null ) {
		$return = '';
		$atts = shortcode_atts( array(
				'source'     => 'none',
				'limit'      => 20,
...
//var_dump($query);
		if ( count( $slides ) ) {
			...
			if ( $atts['link'] === 'lightbox' ) $atts['class'] .= ' su-lightbox-gallery';
			// Open slider
			$return .= '<div id="cat-breves-slider">';
			//$return .= '<div id="' . $id . '" class="su-carousel' . $centered . ' su-carousel-pages-' . $atts['pages'] . ' su-carousel-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '" data-items="' . $atts['items'] . '" data-scroll="' . $atts['scroll'] . '"><div style="height:50px;"></div><div class="lp-border"><div class="su-carousel-slides">';
			$return .= '<div id="' . $id . '" class="su-carousel' . $centered . ' su-carousel-pages-' . $atts['pages'] . ' su-carousel-responsive-' . $atts['responsive'] . su_ecssc( $atts ) . '" style="' . $size . '" data-autoplay="' . $atts['autoplay'] . '" data-speed="' . $atts['speed'] . '" data-mousewheel="' . $mousewheel . '" data-items="' . $atts['items'] . '" data-scroll="' . $atts['scroll'] . '"><div class="su-carousel-slides">';
			// Create slides
			foreach ( (array) $slides as $slide ) {
				...
				$image = su_image_resize( $slide['image'], round( $atts['width'] / $atts['items'] ), $atts['height'] );
//				echo PHP_EOL . $slide['attach_id'];
				//$image_abc = wp_get_attachment_image_src( $slide['attach_id'], '300,300', 0 );
				//$image = $image_abc['0'];
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<a href="' . $slide['link'] . '"' . $target . '><div class="tcpf cat_carousel_title"><h4>' . stripslashes( $slide['title'] ) . '</h4></div></a>' : '';
				...
				//if ( $slide['link'] ) $return .= '<a href="' . $slide['link'] . '"' . $target . '><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" /></a>';
				//if ( $slide['link'] ) $return .= '<div style="border:0px;max-width:200px;padding:5px;"><a href="' . $slide['link'] . '"' . $target . '><img src="' . $image . '" alt="' . esc_attr( $slide['title'] ) . '" /></a></div>';
				if ( $slide['link'] ) $return .= '<a href="' . $slide['link'] . '"' . $atts['target'] . '><img src="' . $image['url'] . '" alt="' . esc_attr( $slide['title'] ) . '" width="' . $atts['width'] . '" height="' . $atts['height'] . '" /></a>';
				// Slide content without link
			...
			//$return .= '</div>';
			$return .= '</div>';
			$return .= '<div id="breveswrapper"><div id="brevescolumn"></div></div><div id="brevesleftcolumn"></div><div id="brevesrightcolumn"></div>';
			// Open nav section
			$return .= '<div class="su-carousel-nav">';
			// Append direction nav
			if ( $atts['arrows'] === 'yes'
			...
			// Close slider
			$return .= '</div>';
			//$return .= '<div style="width:100%"><div style="display:table-cell;float:right;height:30px;width:30px;"></div><div style="display:table-cell;float:right;height:30px;width:30px;"></div><div style="display:table-cell;float:left;height:30px;width:100%;"></div></div>';
			$return .= '</div>';
...
$last_month = date("Y-m-d", strtotime("- 1 month"));
		$args['date_query'] = array(array('column' => 'post_date', 'after' => $last_month));
		// Ignore Sticky Posts
