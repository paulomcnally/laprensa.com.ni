...
class Su_Data {
	...
	public static function shortcodes( $shortcode = false ) {
		$shortcodes = apply_filters( 'su/data/shortcodes', array(
				...
				'cat_carousel' => array(
					...
					'atts' => array(
						...
						'items' => array(
							...
							'default' => 3,
							'name' => __( 'Items to show', 'su' ),
							'desc' => __( 'How many carousel items is visible', 'su' )
						),
						'scroll' => array(
							'type' => 'number',
							'min' => 1,
							...
							'step' => 1, 'default' => 1,
							'name' => __( 'Scroll number', 'su' ),
							'desc' => __( 'How many items are scrolled in one transition', 'su' )
						),
						'title' => array(
							'type' => 'bool',
							'default' => 'yes',
						...
						'meta' => array(
							'default' => '',
							'name' => __( 'meta_key', 'su' ),
							'desc' => __( 'Meta key to include', 'su' )
						)
					),
					'desc' => __( 'Customizable image carousel', 'su' ),
					'icon' => 'picture-o'
				...
				// cat_breves_carousel
				'cat_breves_carousel' => array(
					'name' => __( 'Cat_Breves_Carousel', 'su' ),
					'type' => 'single',
					'group' => 'gallery',
					'atts' => array(
						'source' => array(
