 ...
 */
/*
Plugin Name: Archive Calendar Stateful Shortcode
Plugin URI: http://wordpress.org/extend/plugins/devops_and_platforms/
Description: Adds a archive calendar shortcode that is aware if the archive flag is set.  It is to be used in the sidebars. Usage is [archive_calendar].  Enjoy!  DevOps and Platforms is a modern web hosting platform that allows you to easily launch websites into the cloud.  Your pages will automatically be served from <cite>2</cite> datacenters.  For more information about doap.com or help with setting up your free site, drop a line to <a href="mailto:info@doap.com">info@doap.com</a>
...
echo ('<div style=width:250px;position:relative;left:24px;>');
...
add_shortcode('archive-calendar', 'archive_calendar'); 
// and to make sure Wordpress calls shortcode in sidebars

//add_action( 'widget_text', 'archive_calendar_css' );
