...
class EarthQuakeMonitor extends WP_Widget {
	...
	function form( $instance ) {
		...
		$value = "significant_hour"; echo "<option value='{$value}'" . ( $feed == $value ? "selected='selected'" : '' ) . ">Los terremotos significativos (Past hour)</option>";
		...
		$value = "significant_day"; echo "<option value='{$value}'" . ( $feed == $value ? "selected='selected'" : '' ) . ">Los terremotos significativos (Past day)</option>";
		...
		$value = "significant_week"; echo "<option value='{$value}'" . ( $feed == $value ? "selected='selected'" : '' ) . ">Los terremotos significativos (Past week)</option>";
		...
		$value = "significant_month"; echo "<option value='{$value}'" . ( $feed == $value ? "selected='selected'" : '' ) . ">Los terremotos significativos (Past month)</option>";
		echo "</select></p>";
