...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/suplementos/negocios/";
echo $year . PHP_EOL;
echo $numday . PHP_EOL;
echo $day . PHP_EOL;
...
//											usleep(500000);
											...
											file_put_contents($cat_post_orig, $redirect_file_content);
									                ...
									                $post_term_results = wp_set_post_terms( $post_id, 31, 'category' );
//											usleep(500000);
