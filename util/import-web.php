...
//$categories_to_import = "5, 53, 7, 29, 1, 27, 3, 11, 35, 10, 31, 34, 9, 52, 2, 30, 21, 6, 8, 32, 56, 43, 19, 12, 28, 36, 33, 51, 24, 23, 20, 49, 22";
//$categories_to_import = "30, 53, 21, 35, 34";
//$categories_to_import = "29, 31, 27, 52";
...
//		$sql = "SELECT noticia.idnoticia, noticia.creacion, seccion.seccion, seccion.idseccion, noticia.noticia, noticia.resumen, noticia.texto, noticia.ultimahora, noticia.claves, noticia.intro, noticia.antetitulo, noticia.ubicacion, noticia.orden, edicion.edicion FROM noticia, seccion, edicion WHERE noticia.idnoticia > 197859 and seccion.idseccion = noticia.idseccion and edicion.idedicion = noticia.idedicion and noticia.idnoticia NOT IN ($metavals4) and seccion.idseccion IN ($categories_to_import) ORDER BY noticia.idnoticia DESC limit $limit"; 
		$sql = "SELECT noticia.idnoticia, noticia.creacion, seccion.seccion, seccion.idseccion, noticia.noticia, noticia.resumen, noticia.texto, noticia.ultimahora, noticia.claves, noticia.intro, noticia.antetitulo, noticia.ubicacion, noticia.orden, edicion.edicion FROM noticia, seccion, edicion WHERE seccion.idseccion = noticia.idseccion and edicion.idedicion = noticia.idedicion and noticia.idnoticia NOT IN ($metavals4) and seccion.idseccion IN ($categories_to_import) and noticia.idedicion IN ($editions_to_import) ORDER BY noticia.idnoticia DESC limit $limit"; 
		}
	else
		{
		$sql = "SELECT noticia.idnoticia, noticia.creacion, seccion.seccion, seccion.idseccion, noticia.noticia, noticia.resumen, noticia.texto, noticia.ultimahora, noticia.claves, noticia.intro, noticia.antetitulo, noticia.ubicacion, noticia.orden, edicion.edicion FROM noticia, seccion, edicion WHERE seccion.idseccion = noticia.idseccion and edicion.idedicion = noticia.idedicion and noticia.idnoticia and seccion.idseccion IN ($categories_to_import) and noticia.idedicion IN ($editions_to_import) ORDER BY noticia.idnoticia DESC limit $limit"; 
...
echo '<br>' . PHP_EOL . $i . ' Posts Processed ' . PHP_EOL;
echo '<br>' . PHP_EOL . "start time : $start_time";
echo '<br>' . PHP_EOL . "end time: " . date("Y-m-d H:i:s") . PHP_EOL;
echo '<br>' . PHP_EOL . "today : $today";
echo '<br>' . PHP_EOL . "edicion: $articleedition";
//get_footer();
