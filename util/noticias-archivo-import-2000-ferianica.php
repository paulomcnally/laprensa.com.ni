...
EOD;
$start_date = strtotime("2004-07-24");
$end_date = strtotime("2006-03-01");
$categories_to_import = array("ferianica");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("ferianica" => 63968);
...
$post_text = getTextBetween($cat_post_text, '<!--texto-->', '</FONT><img src="/img/cuadritonaranja.gif');
...
$post_text = $intro_text . $autor_text . $post_text;
		...
		$query = 'SELECT distinct meta_value FROM wp_2_postmeta where meta_key = "lparchivo" and meta_value = "' . $cat_post_file . '" LIMIT 1;'; 
