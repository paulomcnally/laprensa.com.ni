...
try	{
	...
	if ($metavals4)
		...
		$sql = "select  noticia.idnoticia, noticia.creacion, seccion.seccion, seccion.idseccion, noticia.noticia, noticia.resumen, noticia.texto, noticia.ultimahora, noticia.claves, noticia.intro, noticia.antetitulo, noticia.ubicacion from noticia, seccion WHERE noticia.idnoticia > 50000 and noticia.idnoticia < 60001 and seccion.idseccion = noticia.idseccion and noticia.idnoticia NOT IN ($metavals4) and seccion.idseccion IN ($categories_to_import) ORDER BY noticia.idnoticia asc limit $limit"; 
		}
	else
		{
