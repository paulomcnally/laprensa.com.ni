...
$noticias_imported= $wpdb->get_col( "SELECT ID FROM `wp_2_posts` where post_author = 109 and post_type = 'post' and post_status = 'publish' and post_modified > '2014-08-15' order by abs(ID) ASC;");
