...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/suplementos/deportivo/";
echo $year . PHP_EOL;
echo $numday . PHP_EOL;
echo $day . PHP_EOL;
...
$catfileinfo=$fileinfo;
					    		...
					    		if (!$catfileinfo->isDot() && $catfileinfo != "index.shtml" && !substr_count($catfileinfo,"_print"))
							{
								...
								if ($extension == 'shtml')
								{
									...
									{
echo 'FILE EXISTS!! ' . $cat_post_body . PHP_EOL;
...
//											usleep(500000);
											...
											file_put_contents($cat_post_orig, $redirect_file_content);
									                ...
									                $post_term_results = wp_set_post_terms( $post_id, 17, 'category' );
//											usleep(500000);
...
{
echo 'CAT_POST_BODY ' . $cat_post_body . ' DOES NOT EXIST!' . PHP_EOL;
}
								}
