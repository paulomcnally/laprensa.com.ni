...
$categories_to_import = array("reportajes");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("reportajes" => 63721);
$q = 0;
$i = $start_date;
...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/especiales/";
echo $year . PHP_EOL;
echo $numday . PHP_EOL;
echo $day . PHP_EOL;
