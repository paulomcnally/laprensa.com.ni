...
$start_date = strtotime("2006-03-04");
$end_date = strtotime("2009-11-01");
...
$categories_to_import = array("literaria");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("literaria" => 35630);
$q = 0;
$i = $start_date;
...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/suplementos/prensaliteraria/";
echo $year . PHP_EOL;
echo $numday . PHP_EOL;
echo $day . PHP_EOL;
...
//echo PHP_EOL . '1 - cat text ' . $cat_post_text . PHP_EOL;
										$cat_post_text = str_replace($remove_txt1, "", $cat_post_text );
//echo PHP_EOL . '2 - cat text ' . $cat_post_text . PHP_EOL;
										$cat_post_text = str_replace($remove_txt2, "", $cat_post_text );
//echo PHP_EOL . '3 - cat text ' . $cat_post_text . PHP_EOL;
										$cat_post_text = str_replace($table_tags, "", $cat_post_text );
//echo PHP_EOL . '4 - cat text ' . $cat_post_text . PHP_EOL;
										$cat_post_text = replaceTextTables($cat_post_text);
//echo PHP_EOL . '5 - cat text ' . $cat_post_text . PHP_EOL;
										$cat_post_text = removeEmptyLines($cat_post_text);
//echo PHP_EOL . '6 - cat text ' . $cat_post_text . PHP_EOL;
										if ($has_sidebar)
										{
...
*/	
										...
										echo 'credito interna' . PHP_EOL . $credito_nota_interna . PHP_EOL;
								                ...
								                $articlesection = 35630; 
								                $post_status = 'publish';

//echo PHP_EOL . '7 - cat text ' . $cat_post_text . PHP_EOL;
								                $post = array(
...
//echo PHP_EOL . '8 - cat text ' . $cat_post_text . PHP_EOL;
									if (substr_count($cat_post_file, 'dolo-'))
									{
