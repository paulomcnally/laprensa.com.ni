...
$start_date = strtotime("2006-10-31");
...
$categories_to_import = array("reencuentro");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("reencuentro" => 21);
$q = 0;
$i = $start_date;
...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/nicas/";
echo $year . PHP_EOL;
echo $numday . PHP_EOL;
echo $day . PHP_EOL;
