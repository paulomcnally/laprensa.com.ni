...
//$idnoticias_imported= $wpdb->get_col( "SELECT post_id FROM $wpdb->postmeta where meta_key = 'idnoticia' and ABS(meta_value) > 202489 and ABS(meta_value) < 202609 ORDER BY ABS(post_id) ASC LIMIT $limit;" );
$idnoticias_imported= $wpdb->get_col( "SELECT post_id FROM $wpdb->postmeta where meta_key = 'edicion' and meta_value = '2014-07-10' ORDER BY ABS(post_id) ASC LIMIT $limit;" );
...
$noticias_imported= $wpdb->get_col( "SELECT ID FROM $wpdb->posts WHERE post_status = 'publish' and ID IN ($idnoticias_imported_var) ORDER BY ABS(ID) ASC LIMIT $limit;" );
