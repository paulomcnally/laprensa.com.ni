...
$_SERVER[ 'HTTP_HOST' ] = 'laprensa.doap.com';
...
$start_date = strtotime("2006-01-02");
$end_date = strtotime("2006-01-03");
$categories_to_import = array("nacionales", "elmundo", "sucesos", "deportes", "economia", "regionales", "editorial", "opinion", "deportes", "politica", "portada");
$s3_destination_base = "s3://s3.laprensa.com.ni";
$section=array("nacionales"=>"1", "elmundo"=>"5", "sucesos"=>"6", "deportes"=>"29", "economia"=>"8", "regionales"=>"9", "editorial"=>"10", "opinion"=>"10", "deportes"=>"29", "politica"=>"30", "portada"=>"43");
...
$cat_post_text = mb_convert_encoding($cat_post_text, "UTF-8", "CP1252");
		...
		$query = 'SELECT distinct meta_value FROM wp_55_postmeta where meta_key = "lparchivo" and meta_value = "' . $catfileinfo . '";'; 
...
$s3pic = "http://du89eogdt5czf.cloudfront.net" . $sourcefiles;
...
$cat_post_text = str_replace($pic_search_string, $pic_replace_string, $cat_post_text);
