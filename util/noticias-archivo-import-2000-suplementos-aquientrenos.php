...
EOD;
$start_date = strtotime("2005-02-11");
$end_date = strtotime("2006-03-02");
$categories_to_import = array("aquientrenos");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("aquientrenos" => 924);
...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/aquientrenos/";
			echo $year . PHP_EOL;
			echo $numday . PHP_EOL;
			echo $day . PHP_EOL;
...
file_put_contents($cat_post_orig, $redirect_file_content);
                ...
                $post_term_results = wp_set_post_terms( $post_id, 924, 'category' );
		//usleep(50000);
