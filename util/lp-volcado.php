...
$categories_to_import = "2, 30, 5, 53, 9, 52, 31, 21, 34";
...
try	{
	...
	if ($metavals4)
		...
		$sql = "SELECT noticia.idnoticia, noticia.creacion, seccion.seccion, seccion.idseccion, noticia.noticia, noticia.resumen, noticia.texto, noticia.ultimahora, noticia.claves, noticia.intro, noticia.antetitulo, noticia.ubicacion, noticia.orden, edicion.edicion FROM noticia, seccion, edicion WHERE noticia.idnoticia > 197859 and seccion.idseccion = noticia.idseccion and edicion.idedicion = noticia.idedicion and noticia.idnoticia NOT IN ($metavals4) and seccion.idseccion IN ($categories_to_import) and noticia.idedicion = 1793 ORDER BY noticia.idnoticia DESC limit $limit"; 
...
//usleep(50000);
			...
			$update_post = array(
					  ...
					  'post_status'    => 'draft' ////The time post was made, in GMT.
			);  
