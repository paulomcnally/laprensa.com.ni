...
$start_date = strtotime("2002-11-14");
...
$categories_to_import = array("portada");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("portada"=>"3680");
$q = 0;
$i = $start_date;
						...
						foreach ($catdir as $catfileinfo)
						{
					    		if (!$catfileinfo->isDot() && $catfileinfo != "index.shtml" && !substr_count($catfileinfo,"_print"))
							{
								...
								$extension = strtolower(substr(strrchr($catfileinfo, '.'), 1));
									...
									$cat_cari_image = $cat_dir . 'portada_' . $year . $nummonth . $numday . '.jpg';
									$cat_post_pic = 'portada-impresa-' . $year . '-' . $nummonth . '-' . $numday . '.jpg';
