...
$noticias_imported= $wpdb->get_col( "SELECT ID FROM $wpdb->posts where post_type = 'infografia' and post_status = 'publish' and ID < 300000 ORDER BY ABS(ID) ASC LIMIT $limit;" );
