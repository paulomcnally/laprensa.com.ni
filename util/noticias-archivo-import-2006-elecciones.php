...
$start_date = strtotime("2006-10-01");
$end_date = strtotime("2006-12-30");
//$categories_to_import = array("nacionales", "elmundo", "sucesos", "deportes", "economia", "regionales", "editorial", "opinion", "politica", "portada");
$categories_to_import = array("boaco", "candidatos", "carazo", "chinandega", "chontales", "diputados_nacionales", "esteli", "granada", "jinotega", "leon", "madriz", "managua", "masaya", "matagalpa", "nueva_segovia", "partidos", "raan", "raas", "rio", "rio_san_juan", "rivas");
$s3_destination_base = "s3://laprensa.com.ni";
$section=array("boaco" => 27, "candidatos" => 27, "carazo" => 27, "chinandega" => 27, "chontales" => 27, "diputados_nacionales" => 27, "esteli" => 27, "granada" => 27, "jinotega" => 27, "leon" => 27, "madriz" => 27, "managua" => 27, "masaya" => 27, "matagalpa" => 27, "nueva_segovia" => 27, "partidos" => 27, "raan" => 27, "raas" => 27, "rio" => 27, "rio_san_juan" => 27, "rivas" => 27);
$q = 0;
$i = $start_date;
...
$base_dir = "/var/www/html/laprensa/lp-archivo/public_html/archivo/$year/$thismonth/$numday/elecciones/";
echo $year . PHP_EOL;
echo $numday . PHP_EOL;
echo $day . PHP_EOL;
...
//usleep(500000);
											...
											$new_posts[] = 'http://www.laprensa.com.ni/index.php?p=' . $post_id . PHP_EOL;
//											usleep(500000);
									                echo "\n post creado - # = $post_id \n\n";
