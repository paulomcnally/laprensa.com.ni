...
echo do_shortcode('<div style="width:200px;position:relative;float:right;height:350px;border:1px solid #606060;">
<img class="aligncenter" src="http://www.laprensa.com.ni/wp-content/uploads/sites/2/2014/06/logoaquientrenos.svg" alt="" width="138" height="81" />[doap_posts template="templates/list-loop-aqn.php" posts_per_page="10" tax_term="924" tax_operator="0" author="122,123,1,124,102,108,113,114,116,117,121,126,103,111,118,125,112,110,107,115,120,106,104,105,119,109" order="desc" orderby="comment_count" post_parent=" " ignore_sticky_posts="yes"]
</div>');
...
<?php
//echo do_shortcode('[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/'.strtolower($single_cat_title).'"><div class="title-left">'.mb_strtoupper($single_cat_title).'</div><div class="line-container"><div class="line"></div></div></a>[/doap_heading][/doap_animate]');
