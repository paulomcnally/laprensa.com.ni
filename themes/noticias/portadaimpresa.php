...
echo '<a href="http://www.laprensa.com.ni/category/portada-impresa">';
echo do_shortcode('[doap_animate type="fadeIn"][doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://www.laprensa.com.ni/category/noticias/portada-impresa"><div class="title-left">PORTADA IMPRESA</div><div class="line-container"><div class="line"></div></div></a>[/doap_heading][/doap_animate]');
echo '</a>';
...
//	$title = the_title_attribute('echo=0');
		...
		echo '<div style="position:relative;width:270px;;margin-top:0px;margin-bottom:0px;border: 1px solid #ccc;">' . PHP_EOL . '<a href="http://www.laprensa.com.ni/category/portada-impresa"><img src="' . $feat_image . '" width="300"></a>' . PHP_EOL;
		echo '</div>';
	//echo '<div class="mas-en-titles"><p><a href="' . $post_url . '">'. $title . '</a></p></div>' . PHP_EOL;
		...
		echo '<a href="http://tienda.laprensa.com.ni/tienda"><div style="font-family:Arial;font-size:18px;color:#333;text-align:center;">SUSCRIBASE AHORA</div></a>';
		echo '</div>' . PHP_EOL;
	}
echo '</div>' . PHP_EOL;
}
